...
-- and international drug names that are non-trivial to map directly using the concept_relationship table
-- potentially these cases could otherwise be handled via manual usagi mapping

-- map concept "Immune Globulin (Human)" to "immunoglobulin M, human"
update standard_combined_drug_legacy_mapping set standard_concept_id = 42903696 where standard_concept_id = 528263;
-- map concept "Valproate sodium" to "Valproate"
update standard_combined_drug_legacy_mapping set standard_concept_id = 745466 where standard_concept_id = 40239960;
-- map concept "Aricept" to "donepezil"
update standard_combined_drug_legacy_mapping set standard_concept_id = 715997 where standard_concept_id = 40011116;
-- map concept "Rabeprazole Sodium" to "rabeprazole"
update standard_combined_drug_legacy_mapping set standard_concept_id = 911735 where standard_concept_id = 40077081;
-- map concept "Naprosyn" to "Naproxen"
update standard_combined_drug_legacy_mapping set standard_concept_id = 1115008 where standard_concept_id = 40064300;
-- map concept "Tazocin" to "Piperacillin / tazobactam Injectable Solution"
update standard_combined_drug_legacy_mapping set standard_concept_id = 40077118 where standard_concept_id = 40091355;
-- map concept "Azulfidine EN-tabs" to "Sulfasalazine"
update standard_combined_drug_legacy_mapping set standard_concept_id = 964339 where standard_concept_id = 40013106;
-- map concept "Valproic Acid Syrup" to "Valproate"
update standard_combined_drug_legacy_mapping set standard_concept_id = 745466 where standard_concept_id = 40086873;
-- map concept "Senna" to "standardized senna concentrate"
update standard_combined_drug_legacy_mapping set standard_concept_id = 19086491 where standard_concept_id = 40080434;
-- map concept "Vancocin HCl" to "Vancomycin"
update standard_combined_drug_legacy_mapping set standard_concept_id = 1707687 where standard_concept_id = 40086904;
-- map concept "Isopropyl Alcohol" updated to different standard concept "Isopropyl Alcohol"
update standard_combined_drug_legacy_mapping set standard_concept_id = 19028106 where standard_concept_id = 40126573;
-- map concept "ATELVIA" to standard concept "Risedronate"
update standard_combined_drug_legacy_mapping set standard_concept_id = 1516800 where standard_concept_id = 40233365;
-- map concept "DEPAKOTE ER" to standard concept "Valproate Extended Release Oral Tablet [Depakote]"
update standard_combined_drug_legacy_mapping set standard_concept_id = 40154895 where standard_concept_id = 19071592;
-------------------------------------------------------
...
select a.isr, a.standard_concept_id, c.concept_name, c.standard_concept, c.concept_class_id, c.valid_start_date, c.valid_end_date, c.invalid_reason
