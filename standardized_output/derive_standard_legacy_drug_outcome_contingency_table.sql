...
create index ix_standard_legacy_drug_outcome_count on standard_legacy_drug_outcome_count(drug_concept_id, outcome_concept_id);
drop index if exists ix_standard_legacy_drug_outcome_count_2;
create index ix_standard_legacy_drug_outcome_count_2  on faers.standard_legacy_drug_outcome_count  using btree  (drug_concept_id);
