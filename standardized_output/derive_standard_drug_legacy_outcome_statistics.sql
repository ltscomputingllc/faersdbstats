------------------------------
--
-- This SQL script computes the 2x2 contingency table for each legacy drug/outcome pair in a table called standard_drug_legacy_outcome_contingency_table
--
-- It then processes the 2x2 contingency table to create a statistics table called standard_drug_legacy_outcome_stats with the following statistics for each drug/outcome pair:
--
-- 1) case_count
